...
// AMOLED dark theme (#000000 base), no , no styled-jsx
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          ...
          className="h-11 px-5 bg-[#1A1A1A] border border-[#2D2D2D] hover:bg-[#2D2D2D] text-white text-sm font-medium rounded-xl transition-opacity duration-150 min-h-[44px] disabled:opacity-40 disabled:cursor-not-allowed"
        >
           Export CSV
        </button>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full h-11 bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl pl-10 pr-4 text-white text-sm outline-none focus:border-[#7C3AED] transition-opacity duration-150 placeholder:text-[#6B7280]"
          />
        </div>
        ...
        <div className="flex gap-2">
          {([
            ...
            <button
              ...
              className={`h-11 px-4 text-sm font-medium rounded-xl transition-opacity duration-150 min-h-[44px] border ${
                statusFilter === f.key
                  ? f.key === 'banned'
        ...
        <div className="fixed right-0 top-0 h-full w-[360px] max-w-full bg-[#0F0F0F] border-l border-[#1A1A1A] z-[70] flex flex-col">
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-[#1A1A1A]">
            ...
            <button
              ...
              className="min-w-[44px] min-h-[44px] flex items-center justify-center text-[#9CA3AF] hover:text-white transition-opacity duration-150"
            >
              X
            </button>
          </div>
            ...
            <div className="bg-[#1A1A1A] rounded-xl p-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="text-[#6B7280] hover:text-white transition-opacity duration-150 flex-shrink-0 text-xs"
                  title="Copy"
                >
          ...
          <div className="px-5 py-4 border-t border-[#1A1A1A] space-y-2">
            ...
            <button
              ...
              className="w-full h-12 rounded-xl bg-[#EF4444]/10 text-[#EF4444] text-sm font-semibold min-h-[44px] transition-opacity duration-150 hover:bg-[#EF4444]/20"
            >
               Delete Account
            </button>
          </div>
          ...
          <div className="relative w-full max-w-md bg-[#0F0F0F] border border-[#242424] rounded-2xl p-6">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full h-11 bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl px-4 text-white text-sm outline-none focus:border-[#EF4444] transition-opacity duration-150 placeholder:text-[#6B7280]"
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 h-12 rounded-xl border border-[#2D2D2D] text-[#9CA3AF] text-sm font-medium min-h-[44px] transition-opacity duration-150 hover:bg-[#1A1A1A]"
              >
                Cancel
              </button>
              <button
