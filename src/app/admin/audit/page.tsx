    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <button
          ...
          className="min-h-[44px] px-4 py-2 rounded-xl bg-[#121214] border border-[#27272A] hover:bg-[#1E1E22] transition-opacity flex items-center gap-2 text-sm text-[#E4E4E7]"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full min-h-[44px] pl-10 pr-4 rounded-xl bg-[#0F0F11] border border-[#1F1F23] text-white text-sm focus:outline-none focus:border-[#7C3AED] transition-opacity"
          />
        </div>
        ...
        <div className="relative">
          ...
          <select
            ...
            className="w-full min-h-[44px] pl-10 pr-4 rounded-xl bg-[#0F0F11] border border-[#1F1F23] text-white text-sm focus:outline-none focus:border-[#7C3AED] transition-opacity appearance-none cursor-pointer"
          >
            ...
            <table className="w-full border-collapse text-left">
              ...
              <tbody className="divide-y divide-[#1F1F23]">
                {logs.map((log) => {
                  ...
                  return (
                    <tr key={log.id} className="hover:bg-[#121214]/40 transition-opacity">
                      ...
                      <td className="p-4 text-right">
                        <button
                          ...
                          className="min-h-[36px] inline-flex items-center gap-1.5 px-3 py-1 bg-[#18181B] hover:bg-[#27272A] text-[#E4E4E7] text-xs font-medium rounded-lg transition-opacity border border-[#27272A]"
                        >
                          <Eye size={13} />
                          Inspect
                        </button>
        ...
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4 transition-opacity duration-150">
          <div className="bg-[#09090B] border border-[#27272A] w-full max-w-lg rounded-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-4 border-t border-[#27272A] bg-[#121214]/40 flex justify-end">
              <button
                onClick={() => setSelectedLog(null)}
                className="min-h-[38px] px-4 bg-[#7C3AED] hover:bg-[#6D28D9] text-white text-xs font-medium rounded-xl transition-opacity"
              >
                Close Inspector
              </button>
            </div>
