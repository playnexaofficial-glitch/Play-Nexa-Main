    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-[#0F0F0F] border border-[#1A1A1A] rounded-xl p-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            disabled={isChecking}
            className="px-4 py-2 rounded-lg text-white text-xs font-medium min-h-[44px] disabled:opacity-50 bg-[#1A1A1A] border border-[#2D2D2D] hover:border-[#7C3AED]/50 transition-opacity duration-150"
          >
        ...
        <div className="flex flex-wrap gap-2">
          {SAMPLE_CHANNELS.map(ch => (
            <button
              ...
              className={`px-3 py-2 rounded-lg text-xs font-medium min-h-[44px] border transition-opacity duration-150 ${
                channelUrl === ch.url
      ...
      <div className="bg-[#0F0F0F] border border-[#1A1A1A] rounded-xl p-4 space-y-4">
        ...
        <input
          ...
          className="w-full bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl px-4 py-3 text-sm text-white outline-none placeholder-[#9CA3AF] focus:border-[#7C3AED]/50 transition-opacity duration-150"
        />
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <button
              ...
              className={`w-full px-4 py-3 rounded-xl text-sm font-medium min-h-[44px] border transition-opacity duration-150 ${
                useGemini
                  ? 'bg-[#7C3AED]/15 border-[#7C3AED] text-[#A78BFA]'
