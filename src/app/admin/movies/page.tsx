...
export default function MoviesPage() {
  ...
  const [typeFilter, setTypeFilter] = useState<'all' | 'movie' | 'natok'>('all')
  ...
  const loadMovies = useCallback(async () => {
    ...
    try {
      ...
      showToast('Error: ' + (err?.message || 'Failed to load movies'))
    } finally {
      setLoading(false)
    }
  }, [search, typeFilter])
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-[#9CA3AF] mb-3 flex items-center">
