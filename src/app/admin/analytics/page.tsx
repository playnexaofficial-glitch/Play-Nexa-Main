      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-4 max-w-md text-center">
          <div className="w-14 h-14 rounded-2xl bg-[#2A0A0A] border border-[#EF4444]/20 flex items-center justify-center">
            <span className="text-[#EF4444] text-2xl">X</span>
          </div>
          <p className="text-white font-semibold text-lg">Something went wrong</p>
          <p className="text-[#9CA3AF] text-sm">{error}</p>
          <button
            onClick={fetchAnalytics}
            className="min-h-[44px] px-6 bg-[#7C3AED] hover:bg-[#6D28D9] text-white text-sm font-medium rounded-xl transition-opacity duration-150"
          >
            Retry
          </button>
        </div>
                  ...
                  {dailyUsers
                    ...
                    .map((d) => (
                      <button
                        ...
                        className="text-xs px-2.5 py-1.5 rounded-lg bg-[#141416] border border-[#27272A] hover:bg-cyan-950/20 hover:border-cyan-500/40 text-gray-300 hover:text-white transition-all flex items-center gap-1.5 active:opacity-60 min-h-[36px]"
                      >
            ...
            <div className="bg-[#09090B] border border-[#27272A] w-full max-w-2xl rounded-2xl overflow-hidden flex flex-col max-h-[90vh]">
              ...
              <div className="p-4 border-b border-[#27272A] flex items-center justify-between bg-[#121214]/60">
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg hover:bg-white/5 flex items-center justify-center text-gray-400 hover:text-white transition-opacity"
                >
                  <X size={18} />
                </button>
              </div>
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <div className="relative w-full sm:w-48">
                      ...
                      <input
                        ...
                        className="w-full min-h-[32px] pl-8 pr-3 rounded-lg bg-[#121214] border border-[#1F1F23] text-white text-xs focus:outline-none focus:border-cyan-500 transition-opacity"
                      />
                    </div>
                  </div>
                  ...
                  <div className="bg-[#121214] border border-[#1F1F23] rounded-xl overflow-hidden max-h-56 overflow-y-auto divide-y divide-[#1F1F23]/60">
                    {filteredMovies.length === 0 ? (
                      ...
                      filteredMovies.map((m, idx) => (
                        <div key={idx} className="p-3 hover:bg-white/[0.02] transition-opacity flex items-center justify-between text-xs gap-3">
              ...
              <div className="p-4 border-t border-[#27272A] bg-[#121214]/60 flex justify-end">
                <button
                  ...
                  className="min-h-[38px] px-4 bg-cyan-500 hover:bg-cyan-600 text-black font-semibold text-xs rounded-xl transition-opacity active:scale-95"
                >
                  Dismiss Quick-View
                </button>
              </div>
