      ...
      <div className="min-h-screen bg-black flex flex-col px-6 pb-8">
        ...
        <div className="flex-1 flex flex-col items-center justify-center pb-6">
          ...
          <div className="relative mb-6">
            <div className="w-24 h-24 rounded-3xl flex items-center justify-center bg-[#7C3AED]"
            >
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 w-12 h-9 flex items-center justify-center text-[#9CA3AF] text-xs font-semibold"
            >
              {showPass ? 'Hide' : 'Show'}
            </button>
          </div>
