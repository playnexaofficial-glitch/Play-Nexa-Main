...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] pb-24 overflow-x-hidden">
        ...
        <div className="bg-[#1A1A2E] rounded-2xl border border-[#2D2D44] overflow-hidden">
          <div className="flex items-center gap-3 px-4 min-h-[52px] border-b border-[#0D0D0D]">
            ...
            <button
              ...
              className={`w-11 h-6 rounded-full relative transition-opacity duration-150 flex-shrink-0 active:opacity-60 ${
      ...
      {toastMessage && (
        <div className="fixed bottom-24 left-1/2 -translate-x-1/2 bg-[#1A1A2E] border border-[#2D2D44] text-white px-4 py-2.5 rounded-xl text-xs font-medium z-50 pn-page-enter">
          {toastMessage}
        </div>
      )}
    </div>
