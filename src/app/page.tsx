...
import DownloadHeaderButton from '@/components/download/DownloadHeaderButton'
  ...
  return (
    <div className="flex flex-col min-h-screen
        ...
        {features.map((feature) => (
          <button
            ...
            className={`bg-[#12121C] rounded-2xl
              ...
              active:scale-95 active:opacity-60 transition-transform
              duration-150
          ...
          {[
            ...
            <button
              ...
              className="flex items-center gap-2
                ...
                active:opacity-60 flex-shrink-0"
            >
      ...
      <div className="sr-only" aria-hidden="false">
        ...
        <p>
          Play Nexa is an all-in-one free
          entertainment platform. Watch free Bangla
          movies, Hindi movies, Bangla natok,
          web series online in HD. Listen to free
          music, Bangla songs, Hindi songs, lofi,
          remix tracks. Download videos from YouTube,
          TikTok without watermark, Instagram Reels,
          Facebook videos. Play free online games
          and offline games in browser.
        </p>
        <h3>Features on Play Nexa</h3>
        <ul>
          <li>Free Movies &amp; Natok Streaming</li>
          <li>Free Music Player &amp; Audio Streaming</li>
          <li>Video Downloader for 20+ Platforms</li>
          <li>Free Online &amp; Offline Games</li>
          <li>Bangla Entertainment Hub</li>
        </ul>
      </div>
    </div>
  )
