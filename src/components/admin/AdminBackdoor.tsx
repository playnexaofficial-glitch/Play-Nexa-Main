...
const CHANNEL_OPTIONS = [
  ...
  { value: 'Pen Movies', label: 'Pen Movies' },
          ...
          <div className="px-6 pb-6 space-y-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-12 bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl px-4 text-sm text-white outline-none focus:border-[#7C3AED] transition-opacity duration-150 placeholder-[#6B7280]"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full h-12 bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl px-4 pr-12 text-sm text-white outline-none focus:border-[#7C3AED] transition-opacity duration-150 placeholder-[#6B7280]"
                  onKeyDown={e => e.key === 'Enter' && handleAdminLogin()}
                />
                <button
                  type="button"
            ...
            >
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full h-12 bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl px-4 text-sm text-white outline-none focus:border-[#7C3AED] transition-opacity duration-150 appearance-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl px-4 py-3 text-sm text-white outline-none focus:border-[#7C3AED] transition-opacity duration-150 placeholder-[#6B7280] resize-none"
                />
              </div>
                ...
                {movies.map(movie => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="min-w-[36px] min-h-[36px] flex items-center justify-center text-[#6B7280] hover:text-[#EF4444] transition-opacity disabled:opacity-50"
                    >
                      {deletingId === movie.id ? (
