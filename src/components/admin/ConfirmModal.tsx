        ...
        {danger && (
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full h-11 bg-[#1A1A1A] border border-[#2D2D2D] rounded-xl px-4 text-white text-sm outline-none focus:border-[#EF4444] transition-opacity duration-150"
              placeholder="DELETE"
              autoFocus
            />
          </div>
