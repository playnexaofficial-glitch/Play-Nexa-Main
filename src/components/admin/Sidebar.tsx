    ...
    >
      ...
      <div className="px-4 py-4 border-b border-[#1A1A1A] flex items-center justify-between">
        ...
        <button
          ...
          className="w-9 h-9 flex items-center justify-center rounded-lg text-[#9CA3AF] hover:text-white hover:bg-[#1A1A1A] transition-opacity duration-150 min-h-[44px] min-w-[44px] ml-auto"
        >
          {collapsed ? '→' : '←'}
        </button>
      </div>
      ...
      <nav className="flex-1 py-2 overflow-y-auto">
        {NAV_ITEMS.map(item => (
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 text-sm transition-opacity duration-150 min-h-[44px] ${
              isActive(item.href)
      ...
      <div className="px-3 py-3 border-t border-[#1A1A1A]">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-3 text-sm text-[#9CA3AF] hover:text-white hover:bg-[#1A1A1A] rounded-lg transition-opacity duration-150 min-h-[44px] mb-1"
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-3 text-sm text-[#EF4444] hover:bg-[#EF4444]/10 rounded-lg transition-opacity duration-150 min-h-[44px]"
        >
          <span className="text-sm font-semibold shrink-0">Logout</span>
        </button>
      </div>
    </aside>
  )
