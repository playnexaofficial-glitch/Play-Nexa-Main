    ...
    <header className="flex items-center justify-between px-4 lg:px-6 h-14 bg-[#0A0A0A] border-b border-[#1A1A1A] flex-shrink-0">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="w-10 h-10 flex items-center justify-center rounded-lg text-[#9CA3AF] hover:text-white hover:bg-[#1A1A1A] transition-opacity duration-150 md:hidden min-h-[44px] min-w-[44px]"
