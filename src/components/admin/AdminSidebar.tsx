...
const NAV = [
  ...
  { Icon: Clapperboard, label: 'Natok', path: '/admin/natok' },
  ...
  { Icon: Download, label: 'YT Importer', path: '/admin/yt-importer' },
]
    ...
    >
        ...
        {NAV.map(({ Icon, label, path }) => {
          ...
          return (
            <Link
              ...
              href={path}
              onClick={onClose}
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl mb-0.5 min-h-[44px] text-sm font-medium active:opacity-60 transition-opacity duration-150 ${
      ...
      <div className="p-3 border-t border-[#1A1A2E] flex-shrink-0">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl min-h-[44px] text-sm font-medium text-red-400 active:opacity-60 transition-opacity duration-150"
        >
