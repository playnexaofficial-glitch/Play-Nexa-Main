...
export default function AchievementBadge({
  ...
  return (
    <div
      className={`flex flex-col items-center gap-1.5 px-3 py-3 rounded-xl min-w-[76px] flex-shrink-0 border transition-opacity duration-200
        ${
          unlocked
    ...
    >
      <Award size={22} className={unlocked ? 'text-[#A78BFA]' : 'text-[#6B7280]'} />
      <span
