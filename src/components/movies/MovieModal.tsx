...
import MediaDownloadButton from '@/components/download/MediaDownloadButton'
  ...
  return (
    <div className="fixed inset-0 z-[70] flex flex-col overflow-hidden bg-black">
      ...
      <div className="flex-1 overflow-y-auto" style={{ contentVisibility: 'auto' } as React.CSSProperties}>
        ...
        {/* ── ACTION BAR (5 equal buttons) ── */}
        <div className="grid grid-cols-5 px-3 py-3" style={{ borderBottom: '1px solid #1A1A1A' }}>
          {/* Like */}
          <button
            onClick={handleLike}
          ...
          >
            ...
            <span className={`text-[11px] font-medium ${isLiked ? 'text-[#7C3AED]' : 'text-[#9CA3AF]'}`}>
              {isLiked ? 'Liked' : 'Like'}
            </span>
          </button>

          {/* Download (In-App Smart Downloader Pro) */}
          <MediaDownloadButton
            media={{
              id: movie.id,
              ...
              channelName: movie.channel_name || (movie as any).channel,
          ...
          >
            ...
            <span className={`text-[11px] font-medium ${isSaved ? 'text-[#06B6D4]' : 'text-[#9CA3AF]'}`}>
              {isSaved ? 'Saved' : 'Save'}
            </span>
          </button>
          ...
          <button
            onClick={handleShare}
            className="flex flex-col items-center gap-1 min-h-[44px] justify-center active:scale-95 transition-transform"
          >
            ...
            <span className="text-[11px] text-[#9CA3AF]">Share</span>
          </button>
