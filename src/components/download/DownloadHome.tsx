    ...
    <div className="flex flex-col min-h-screen bg-[#0D0D0D] pb-24">
      ...
      <div className="flex items-center justify-between px-4 h-14">
        ...
        <div className="flex items-center justify-end min-w-[44px]">
          <DownloadHeaderButton variant="topbar" />
        </div>
      </div>

      <div className="px-4 space-y-5 pt-2">
        {/* ── LIVE DOWNLOAD MANAGER BANNER ── */}
        <button
          onClick={() => router.push('/downloads')}
          className="w-full flex items-center justify-between p-3.5 rounded-2xl bg-gradient-to-r from-[#1A1A2E] to-[#12121E] border border-[#7C3AED]/30 shadow-lg shadow-purple-950/20 active:scale-[0.98] transition-all text-left"
        >
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#7C3AED] to-[#06B6D4] text-white shadow-md shadow-purple-500/20">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-white font-bold text-sm">Download Center</span>
                <span className="bg-[#7C3AED]/30 text-[#A78BFA] text-[10px] font-extrabold px-1.5 py-0.5 rounded border border-[#7C3AED]/40 uppercase tracking-wider">Live</span>
              </div>
              <p className="text-neutral-400 text-xs mt-0.5">Vidmate-style live queue & offline storage</p>
            </div>
          </div>
